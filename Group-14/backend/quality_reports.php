...
$sql = "SELECT * FROM quality_reports_t";
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Records and Quality Reports</h4>
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . $quantity . "</td>";
                            if ($grade === "A") {
                                echo "<td><label class='badge badge-success'>" . $grade . "</label></td>";
                            }
                            else if ($grade === "B") {
                                echo "<td><label class='badge badge-warning'>" . $grade . "</label></td>";
                            }
                            else {
                                echo "<td><label class='badge badge-danger'>" . $grade . "</label></td>";
                            }
                            echo "</tr>";
                        }
                        ?>
