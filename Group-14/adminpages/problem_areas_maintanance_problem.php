            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="problem_areas_overdose_pesticide.php"> Overdose of Pesticide </a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <button class="btn btn-gradient-primary btn-fw"><a href="maintain-2021.php" target="_blank">2021</a></button>
                <button class="btn btn-gradient-secondary btn-fw"><a href="maintain-2022.php" target="_blank">2022</a></button>
                <button class="btn btn-gradient-success btn-fw"><a href="maintain-2023.php" target="_blank">2023</a></button>
              </div>
              </div>
