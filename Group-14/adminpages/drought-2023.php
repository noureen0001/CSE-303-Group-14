...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Drought' AND Year = 2023";
...
<html lang="en">
  <head>
    ...
    <title>Drought 2023 | Admin</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pie Chart - Drought (2023)</title>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Drought in year 2023 </h3>
            </div>
