...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Heavy rainfall' AND Year = 2021";
...
<html lang="en">
  <head>
    ...
    <title>Heavy Rainfall 2021 | Admin</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pie Chart - Heavy Rainfall (2022)</title>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Heavy Rainfall in year 2021 </h3>
            </div>
