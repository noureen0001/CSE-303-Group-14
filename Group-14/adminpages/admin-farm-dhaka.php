...
$dis = "Dhaka";
$sql = "SELECT * FROM farm_t WHERE farm_t.District='$dis'";
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Farms In Dhaka</h4>
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . $district . "</td>";
                            echo "<td><button type='submit' name='remove_farm' value='" . $farm_id . "'>Remove</button></td></tr>";
                          }
                        ?>
                        </form>
                      </tbody>
