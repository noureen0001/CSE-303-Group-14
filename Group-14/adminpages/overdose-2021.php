...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Overdose of pesticide' AND Year = 2021";
...
<html lang="en">
  <head>
    ...
    <title>Overdose of pesticide 2021 | Admin</title>
    <meta charset="UTF-8">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Crop Quantities Affected by Overdose of pesticide (2021) </h3>
            </div>
