...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Maintenance problem' AND Year = 2022";
...
<html lang="en">
  <head>
    ...
    <title>Maintenance problem 2022 | Admin</title>
    <meta charset="UTF-8">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Crop Quantities Affected by Maintenance problem (2022) </h3>
            </div>
