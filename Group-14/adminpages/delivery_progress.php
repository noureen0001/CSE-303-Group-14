          ...
          <div class="content-wrapper">
            ...
            <div class="card-body">
              <table class="table table-striped">
                      ...
                      <tbody>
                        <form action="../backend/remove-delivery.php" method="POST">
                        <?php

                          $sql = "SELECT * FROM delivery_progress_t";
                          ...
                          while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . $packaging_unit . "</td>";
                            echo "<td>" . $delivery_status . "</td>";

                            echo "<td><button type='submit' name='remove_delivery' value='" . $lot_id . "'>Remove</button></td></tr>";
                          }
