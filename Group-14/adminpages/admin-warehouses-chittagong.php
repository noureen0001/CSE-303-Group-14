...
$div = "Chittagong";
$sql = "SELECT WarehouseID, FName, LName, warehouse_manager_t.AreaName, warehouse_manager_t.District FROM warehouse_manager_t JOIN warehouse_t ON warehouse_t.WHManagerID=warehouse_manager_t.WHManagerID WHERE warehouse_manager_t.Division='$div'";
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="admin-warehouses-khulna.php"> Khulna </a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="main-panel">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Warehouses in Chittagong</h4>
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <form action="../backend/remove-warehouse.php" method="post">
                        <?php
                          echo "<tr>";
                          ...
                          while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . $manager_name . "</td></tr>";
                            echo "<td><button type='submit' name='remove_warehouse' value='" . $warehouse_id . "'>Remove</button></td></tr>";
                          }
                        ?>
                      </form>
                      </tbody>
