        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <form action="view_map.php" method="POST">
                    <?php
                        include '../backend/connect.php';
                        $sql = "SELECT * FROM  tracking_product_t";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            $_SESSION['storage_location'] = $storage_location;
                            $_SESSION['storage_latitude'] = $storage_latitude;
                            $_SESSION['storage_longitude'] = $storage_longitude;
                            $_SESSION['destination'] = $destination;
                            $_SESSION['destination_latitude'] = $destination_latitude;
                            $_SESSION['destination_longitude'] = $destination_longitude;

                            echo "<tr><td>" . $lot_name . "</td>";
                            echo "<td>" . $quantity . "</td>";
                            // echo "<td><button><a href='view_map.php'> View Map </a></button></td></tr>";
                            echo "<td><button type='submit' name='view_map' value='" . $lot_id . "'> View Map </button></td></tr>";
                        }
                    ?>
                </form>
                    </tbody>
