...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Drought' AND Year = 2022";
...
<html lang="en">
  <head>
    ...
    <title>Drought 2022 | Admin</title>
    <meta charset="UTF-8">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Drought in year 2022 </h3>
            </div>
