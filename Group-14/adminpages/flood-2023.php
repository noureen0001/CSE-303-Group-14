...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Flooding' AND Year = 2023";
...
<html lang="en">
  <head>
    ...
    <title>Flooding 2023 | Admin</title>
    <meta charset="UTF-8">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Crop Quantities Affected by Flooding (2023) </h3>
            </div>
