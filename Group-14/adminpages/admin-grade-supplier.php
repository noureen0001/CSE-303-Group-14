                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <form action="../backend/grade-supplier.php" method="POST">
                        <?php
                          echo "<tr>";

                          while ($row = mysqli_fetch_array($result)) {
                            echo "<td ClassName='py-1'>";
                            echo "<img src='../assets/images/faces-clipart/pic-3.png' " . "alt=image' /></td>";
                            $supplier_id = $row['SupplierID'];
                            $name = $row['Name'];
                            $area_name = $row['AreaName'];
                            $district = $row['District'];
                            $grade = $row['GradeRequirement'];

                            echo "<td>" . $name . "</td>";
                            echo "<td>" . $area_name . "</td>";
                            echo "<td>" . $district . "</td>";
                            echo "<td>" . $grade . "</td>";
                            echo "<td><button type='submit' name='grade_supplier' value='" . $supplier_id . "'>Grade</button></td></tr>";
                          }
                        ?>
                        </form>
                      </tbody>
