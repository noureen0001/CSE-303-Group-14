...
$sql = "SELECT CropName, Quantity FROM problem_areas_t WHERE Problem = 'Insect attack' AND Year = 2022";
...
<html lang="en">
  <head>
    ...
    <title>Insect Attack 2022 | Admin</title>
    <meta charset="UTF-8">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Crop Quantities Affected by Insect Attacks (2022) </h3>
            </div>
