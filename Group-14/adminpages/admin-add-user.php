        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" action="../backend/add-user.php" method="post">
                        <div class="form-group">
                        <label for="exampleInputUsername1">Enter NID(User ID)</label>
                        <input type="text" class="form-control" placeholder="Username" name="nid">
                        </div>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Working Location</label>
                        <input type="text" class="form-control" placeholder="Location" name="work_location">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">Officer Type</label>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="user_type" value="Grading Unit Manager"> Grading Unit Manager </label>
                            </div>
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="user_type"  value="Nutritionist" checked> Nutritionist </label>
                            </div>
