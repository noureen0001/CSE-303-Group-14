(function ($) {
  ...
  if ($("#visit-sale-chart").length) {
    ...
    var graphGradient5 = document.getElementById('visit-sale-chart').getContext("2d");
    var graphGradient6 = document.getElementById('visit-sale-chart').getContext("2d");
    var graphGradient7 = document.getElementById('visit-sale-chart').getContext("2d");
    ...
    gradientStrokeYellow.addColorStop(0, 'rgba(255, 291, 150, 1)');
    gradientStrokeYellow.addColorStop(1, 'rgba(254, 152, 145, 1)');
    var gradientLegendYellow = 'linear-gradient(to right, rgba(255, 191, 150, 1), rgba(254, 152, 145, 1))';
    ...
    const bgColor3 = ["rgba(25, 191, 150, 1)"];
    const bgColor4 = ["rgba(255, 291, 150, 1)"];
    const bgColor5 = ["rgba(111, 291, 150, 1)"];
    const bgColor6 = ["rgba(255, 131, 150, 1)"];
    const bgColor7 = ["rgba(255, 191, 160, 1)"];
